...
public class TheHeadOfTheSection {
    ...
    public TheHeadOfTheSection(String id, String initials, String dateOfBirth, String dateOfHiring, String numberOfPhone, String address, String salary, String externalCommunicationWithThePlaceOfWork, LocalDateTime dateOfCreation, LocalDateTime dateOfModified, String description) {
        this.id = id;
