...
<form name="directoryOfGoodsNomenclature" action="" method="POST" style="width: 700px; height: 500px; line-height: 2; margin-left: 15px; margin-top: 8px">
    The Name Of The Product:<@spring.formInput "directoryOfGoodsNomenclatureForm.theNameOfTheProduct" "" "text"/>
    <br>
    Description:<@spring.formInput  "directoryOfGoodsNomenclatureForm.description" "" "text"/>
    <br>
